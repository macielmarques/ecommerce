								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
													<input type="radio" id="mothod-pagseguro" name="payment-method" placeholder="País" value="1" style="float: left; margin: 30px;">
													<label class="" for="mothod-pagseguro"><img style="height: 64px;" src="/res/site/img/logo-pagseguro.png"></label>
												</p>
												<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
													<input type="radio" checked="checked" id="mothod-paypal" name="payment-method" placeholder="País" value="2" style="float: left; margin: 30px;">
													<label class="" for="mothod-paypal"><img style="height: 64px;" src="/res/site/img/logo-paypal.png"></label>
												</p>
											<div id="payment">
